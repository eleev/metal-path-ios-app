...
class Node: NodeType {
    ...
    func prepareModelBuffer() {
        let memoryLayout = MemoryLayout<Uniforms>.size  // TODO: this line needs to be refactored and "magic" numbers need to be removed. In order to do that, the Uniform bridging hearing should be refactored and migrated from Renderer class to MetalView class
